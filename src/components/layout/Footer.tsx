      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="lg:col-span-1">
            <h3 className="font-serif text-4xl font-bold text-white mb-6">سما ذاخر</h3>
            <p className="font-sans text-white/50 mb-8 leading-relaxed">
              وجهتك المثالية لإقامة روحانية فاخرة في مكة المكرمة، حيث نجمع بين الأصالة والخدمة العصرية.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 font-sans text-white/50">
              <li className="flex items-start gap-3">
                ...
                <span>شارع إبراهيم الخليل، مكة المكرمة، المملكة العربية السعودية</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@samathakher.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="relative" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                type="submit"
                className="absolute left-1 top-1 bottom-1 bg-accent hover:bg-red-700 text-white px-6 rounded-full font-sans text-sm transition-colors"
              >
                اشتراك
              </button>
            </form>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 font-sans text-sm text-white/30">
          <p>&copy; {new Date().getFullYear()} سما ذاخر. جميع الحقوق محفوظة.</p>
