  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        >
          حيث تلتقي الفخامة بالروحانية في قلب مكة المكرمة
        </motion.p>
      </motion.div>
      ...
      >
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-full p-2 flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl">
          ...
          <MagneticButton className="w-full md:w-auto">
            <button className="bg-accent hover:bg-red-700 text-white px-8 py-4 rounded-full font-sans font-bold transition-colors w-full md:w-auto">
              احجز الآن
            </button>
          </MagneticButton>
        </div>
