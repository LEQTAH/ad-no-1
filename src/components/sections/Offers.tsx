...
const offers = [
  {
    id: 1,
    title: 'باصات من وإلى الحرم',
    description: 'خدمة نقل ترددية مجانية ومريحة على مدار 24 ساعة لضمان وصولك إلى الحرم المكي الشريف بكل يسر وسهولة.',
    image: 'https://images.unsplash.com/photo-1464219789935-c2d9d9aba644?q=80&w=2000&auto=format&fit=crop',
    tag: 'على مدار الساعة'
  },
  {
    id: 2,
    title: 'خدمة غرف دائمة',
    description: 'استمتع بتناول أشهى المأكولات والمشروبات في راحة غرفتك في أي وقت من اليوم مع خدمة الغرف المتوفرة على مدار الساعة.',
    image: 'https://images.unsplash.com/photo-1621293954908-907159247fc8?q=80&w=2000&auto=format&fit=crop',
    tag: 'خدمة 24/7'
  },
  {
    id: 3,
...
export default function Offers() {
  ...
  return (
    <section ref={containerRef} className="py-32 bg-zinc-950 text-white relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-green-900/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3" />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            <motion.span 
              ...
              className="text-green-500 font-medium tracking-wider uppercase text-sm mb-4 block"
            >
              عروض استثنائية
            </motion.span>
            <motion.h2 
          ...
          {offers.map((offer, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <MagneticButton>
                  <button className="w-full py-4 bg-white text-black rounded-full font-medium hover:bg-green-600 hover:text-white transition-colors duration-300">
                    احجز الآن
                  </button>
                </MagneticButton>
              </div>
